...
var aFriend = [
	{ id: 1, name: '绿巨人', QQid: 189535472},
	{ id: 1, name: '黑寡妇', QQid: 928832952},
	{ id: 1, name: '钢铁侠', QQid: 461984804},
	{ id: 1, name: '雷神', QQid: 672300112},
	{ id: 1, name: '蜘蛛侠', QQid: 115138266},
	{ id: 1, name: '神奇博士', QQid: 617531839},
	{ id: 2, name: '孙悟空', QQid: 877241153},
	{ id: 2, name: '唐僧', QQid: 333072275},
	{ id: 2, name: '沙悟净', QQid: 578252293},
	{ id: 2, name: '猪八戒', QQid: 464345858},
	{ id: 3, name: '林春通', QQid: 969157053},
	{ id: 3, name: '陈建川', QQid: 665254192},
	{ id: 3, name: '陈建峰', QQid: 178972264},
	{ id: 3, name: '王海龙', QQid: 117424028},
	{ id: 3, name: '邵婷婷', QQid: 537238511},
	{ id: 3, name: '罗岚', QQid: 776377818},
	{ id: 4, name: '李逵', QQid: 449142543},
	{ id: 4, name: '林冲', QQid: 469092895},
	{ id: 4, name: '吴用', QQid: 568418263},
	{ id: 4, name: '宋江', QQid: 883004594},
	{ id: 4, name: '武松', QQid: 944897808},
	{ id: 4, name: '时迁', QQid: 397328766}
];
// End好友信息存储
	...
	$.each(aGroup, function(index, item) {
		...
		$.each(aFriend, function(index2, item2) {
			if (item2.id == item.id) {
				...
				var oCont_id = $('<span class="Friend-id"></span>').text('(' + item2.QQid + ')');
				...
				oCont_list.append(oCont_img, oCont_name, oCont_id);
...
function MsgChat(ConName, top, left) {
	...
	this.oBtnS.on('click', function(e) {
		var oDivS = $('<div class="chat-content-group self"></div>');//信息标签DIV
		var oDate = $('<div class="chat-time"></div>');//时间标签包裹
		var oDateS = $('<span></span>').text(chatTime());//发送时间
		var oImg = $('<img src="images/head.jpg" alt="" class="chat-avatar" />');//发送人头像
		var oPn = $('<p class="chat-nick"></p>').text(JSON.parse(localStorage.hx180310QQnowUser).username);//发送人昵称P标签
		var oPc = $('<p class="chat-content"></p>');//信息P标签

		oDate.append(oDateS);
		
		if (self.oInpDiv.html()) {
			oPc.html(self.oInpDiv.html());//获取输入框信息追加于展示标签

			oDivS.append(oDate, oImg, oPn, oPc);
			self.oBody.append(oDivS);
...
$('#LogOut').on('click', function() {
	var Msg = confirm('确定退出当前账户？');

	if (Msg) {
		localStorage.hx180310QQnowUser = '';
		location.reload();
	}
